import numpy as np
from UNav_core.src.third_party.global_feature.mixVPR_main.models import aggregators
from UNav_core.src.third_party.global_feature.mixVPR_main.models import backbones
